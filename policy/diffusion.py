...
# ========= inference  ============
    ...
    def predict_action(self, force) -> Dict[str, torch.Tensor]:
        ...
        sample = self.conditional_sample(
            cond_data, cond_mask,
            local_cond=local_cond, global_cond=global_cond, **self.kwargs)
    ...
    # ========= training  ============
    def compute_loss(self, force, actions):
        ...
        global_cond = force.reshape(batch_size, -1)
